...
<html>
    ...
    <body>
        ...
        <div id="edit-etiqueta" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.etiqueta}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.etiqueta}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.etiqueta}" method="PUT">
                <g:hiddenField name="version" value="${this.etiqueta?.version}" />
                <fieldset class="form">
                    <f:all bean="etiqueta"/>
                </fieldset>
